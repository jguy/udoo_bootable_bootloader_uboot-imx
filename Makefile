...
mx6q_seco_q7_config	: unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6_seco_q7 freescale mx6
	
mx6solo_seco_q7_config		\
mx6dl_seco_q7_config   : unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/mx6_seco_q7/config.tmp ; \
		  echo "... with iram configuration" ; \
		}
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6_seco_q7 freescale mx6	
